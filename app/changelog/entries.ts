...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    publicChanges: [
      'Unified CPU value sizing and padding; clarified index labels, memory loading and desktop interaction cues; improved scheduler rule contrast and explanations, and matched supported lab dropdown menus to the homepage.',
