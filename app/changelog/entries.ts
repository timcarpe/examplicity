...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    publicChanges: [
      'Unified right-aligned Working, exam and checkpoint controls with centered setting labels and neutral selection; simplified Binary’s range menu and value hints. Made neuron boundaries directly draggable with reliable parameter controls when the line leaves view, clarified floating-point normalisation goals and lost-bit feedback, corrected flip-flop wiring, and improved recursive frame labels and programming consoles in light and dark themes.',
