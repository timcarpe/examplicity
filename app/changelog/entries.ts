...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    publicChanges: [
      'Unified right-aligned Working, exam and checkpoint controls with centered setting labels and neutral selection; simplified Binary’s range menu and value hints. Made neuron boundaries directly draggable, clarified floating-point storage controls, moved flip-flop guidance above the circuit, and improved recursive working colours and programming controls in light and dark themes.',
