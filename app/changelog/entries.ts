...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    publicChanges: [
      'Reduced offline download sizes across all 57 labs while keeping their styling and reusable design components for remixing.',
      ...
      'Refreshed ten Mathematics labs covering ratio and flow, relative frequency, conditional probability, scatter diagrams, sets, similarity, solids, time zones, transformations and vectors with shared controls, clearer working and targeted interaction hints. Set Membership now separates goals from live membership facts with clearer Venn cards and checkpoints; Scatter labels have dedicated space, and model resets sit below their goals.',
    ...
    internalChanges: [
      'Completed a catalogue desktop visual spot check. Rolled out PurgeCSS packaging with a canonical remix safelist, runtime attribute extraction and preserved pseudo-class conditions; checked five randomly selected labs against full CSS. Removed the Recursive Call Stacks and Translator size allowances.',
  ...
  },
  {
    ...
    publicChanges: [
      'Refreshed Binary Numbers, Coordinate Geometry, Graph Search, Prime Factors, Sequences and Histograms with consistent controls, clearer working and progress feedback, readable diagrams and movable completion prompts.',
      'Improved Repeated Percentage Change, Motion Graphs, Bounds, Straight Lines and Recurring Decimals with clearer working, contextual interaction hints and smoother chart dragging. Restored direct percentage-bar manipulation and Bounds’ interval exploration, digital measurements and worst-case proof feedback.',
      'Refreshed Circle Theorems and four Trigonometry labs with clearer working steps, readable diagrams and contextual hints while preserving their geometric interactions. Made 3D construction colours easier to distinguish from success feedback.',
    ...
    internalChanges: [
      ...
      'Added the living design guide and Lab Kit resources under /developer, with reusable styles and interaction helpers embedded in published and downloaded labs. Documented the reviewed design patterns and adaptation lessons.',
