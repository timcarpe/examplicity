...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    internalChanges: [
      'Documented a three-owner plan for queryable concept- and syllabus-centred exam evidence, cross-curriculum comparisons and reviewed lab adaptations, including complete paper coverage, task coordination and authoring-workflow updates.',
