...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    internalChanges: [
      'Documented a three-owner plan for queryable concept- and syllabus-centred exam evidence, reviewed demand summaries, cross-curriculum comparisons and lab adaptations, including complete paper coverage, task coordination and authoring-workflow updates.',
