...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    publicChanges: [
      'Updated Binary Numbers, Coordinate Geometry, Graph Search, Prime Factors, Sequences and Histograms with clearer working areas and consistent progress feedback. Added consistent activity top panels and blue or grey action buttons, lightweight action and calculation cards, rounded grey Working and blue exam toggles with subtle container shadows and regular-weight labels, movable completion cards and improved chart dragging and readability.',
