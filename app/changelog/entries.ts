...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    publicChanges: [
      'Refreshed Lens Imaging, Critical Angle, Diffraction, Gas Compression and Selection Pressure with clearer predictions, readable evidence, consistent checkpoints and contextual interaction hints while preserving their scientific models. Refined direct grips, measurement cards, first-action pulses and Selection’s taller, higher-contrast frequency plot.',
