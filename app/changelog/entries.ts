...
export const changelogEntries: readonly ChangelogEntry[] = [
  {
    ...
    publicChanges: [
      'Clarified computing-lab live values, index labels, memory loading and desktop interaction cues; improved scheduler rule contrast and explanations, and matched supported lab dropdown menus to the homepage.',
