    ...
    qualificationViews: {
      ...
      A: {
        ...
        topicBriefings: {
          ...
          'Logic circuits': 'Build combinational circuits, then operate flip-flop feedback to see how sequential logic stores state for Cambridge International A Level Computer Science 9618.',
          'Artificial intelligence': 'Compare Dijkstra and A* searches, then investigate how weights and thresholds shape an artificial neuron decision for Cambridge International A Level Computer Science 9618.',
          Programming: 'Write, translate and trace programs, including recursive calls and their returning stack frames, for Cambridge International A Level Computer Science 9618 exam practice.',
        } satisfies Partial<Record<Topic, string>>,
      },
    },
  },
...
export const labs: Lab[] = [
  ...
  },
  {
    ...
    description: 'Explore measurement intervals in Core, or continue to calculated speed bounds and a guarantee proof in Extended.',
    ...
    subtitle: 'Explore measurement intervals in Core, or continue to speed bounds and a guarantee proof in Extended.',
    topic: 'Numbers',
    format: 'Bounds proof',
    kind: 'lab',
    syllabuses: [
  ...
  {
    subject: 'computer-science',
    slug: 'logic-circuit-flip-flop',
    title: 'Flip-Flops and Sequential Logic',
    description: 'Operate set, hold and reset inputs on a feedback circuit, then compare how SR and JK flip-flops preserve or change a stored bit.',
    metaDescription: 'Explore SR and JK flip-flops, feedback and stored state for Cambridge International A Level Computer Science 9618.',
    subtitle: 'Operate the feedback loop, release the input, and see why the stored output depends on earlier state; then test JK on a clock edge.',
    topic: 'Logic circuits',
    format: 'Sequential circuit model',
    kind: 'lab',
    syllabuses: [
      { code: '9618', qualification: 'A', sections: [{ id: '15.2', page: 34, primary: true }] },
    ],
    href: '/labs/computer-science/logic-circuit-flip-flop.html',
  },
  {
    subject: 'computer-science',
    slug: 'recursive-call-stack',
    title: 'Recursive Call Stacks',
    description: 'Step through recursive calls, watch each frame preserve its local value, and follow return values back through the stack after the base case.',
    metaDescription: 'Trace recursive calls, stack frames, base cases and returned values for Cambridge International A Level Computer Science 9618.',
    subtitle: 'Step into each call, watch its frame wait, then follow values back through the stack after the base case.',
    topic: 'Programming',
    format: 'Call-stack tracer',
    kind: 'lab',
    syllabuses: [
      { code: '9618', qualification: 'A', sections: [{ id: '19.2', page: 37, primary: true }] },
    ],
    href: '/labs/computer-science/recursive-call-stack.html',
  },
  {
    subject: 'computer-science',
    slug: 'single-neuron-threshold',
    title: 'Artificial Neuron Decision Boundaries',
    description: 'Adjust input weights and a threshold, watch the decision boundary move, and test why one artificial neuron cannot represent XOR.',
    metaDescription: 'Explore weighted inputs, thresholds and decision boundaries in a single artificial neuron for Cambridge International A Level Computer Science 9618.',
    subtitle: 'Tune the weights and threshold, test the four binary inputs, and use the moving boundary to discover both the power and limit of one neuron.',
    topic: 'Artificial intelligence',
    format: 'Neuron decision model',
    kind: 'lab',
    syllabuses: [
      { code: '9618', qualification: 'A', sections: [{ id: '18.1', page: 36, primary: true }] },
    ],
    href: '/labs/computer-science/single-neuron-threshold.html',
  },
  {
    subject: 'mathematics',
    slug: 'relative-frequency-bias-expected-frequency',
    title: 'Relative Frequency, Bias and Expected Frequency',
    description: 'Run repeated spinner trials, compare relative frequencies with theoretical probability, and test how bias changes expected outcomes.',
    metaDescription: 'Explore relative frequency, expected frequency and experimental bias for Cambridge IGCSE Mathematics 0580 Core and Extended.',
    subtitle: 'Run and compare repeated trials, decide whether the evidence supports a fair spinner, then use the model to predict expected frequencies.',
    topic: 'Probability',
    format: 'Spinner investigation',
    kind: 'lab',
    syllabuses: [
      {
        code: '0580',
        qualification: 'IGCSE',
        sections: [
          { id: 'C8.2', page: 29, primary: true },
          { id: 'E8.2', page: 54 },
        ],
      },
    ],
    href: '/labs/mathematics/relative-frequency-bias-expected-frequency.html',
  },
  {
    subject: 'mathematics',
    slug: 'replacement-conditional-sample-spaces',
    title: 'Replacement and Conditional Sample Spaces',
    description: 'Build two-draw sample spaces, switch replacement on and off, and connect changing branches to conditional probabilities.',
    metaDescription: 'Explore combined events, conditional probability and sampling with and without replacement for Cambridge IGCSE Mathematics 0580.',
    subtitle: 'Drag outcomes into a live two-draw model, compare replacement rules, and use the changing sample space to explain conditional probability.',
    topic: 'Probability',
    format: 'Conditional sample-space model',
    kind: 'lab',
    syllabuses: [
      {
        code: '0580',
        qualification: 'IGCSE',
        sections: [
          { id: 'C8.3', page: 30, primary: true },
          { id: 'E8.3', page: 54 },
          { id: 'E8.4', page: 54 },
        ],
      },
    ],
    href: '/labs/mathematics/replacement-conditional-sample-spaces.html',
  },
  {
    subject: 'mathematics',
    slug: 'similarity-scale-effects',
    title: 'Similarity and Scale Effects',
    description: 'Resize similar shapes and solids, then compare how length, area and volume respond to the same scale factor.',
    metaDescription: 'Explore similar shapes and the effects of scale factor on length, area and volume for Cambridge IGCSE Mathematics 0580.',
    subtitle: 'Change one linear scale factor, test the resulting models, and discover why area and volume grow at different rates.',
    topic: 'Geometry',
    format: 'Scale model',
    kind: 'lab',
    syllabuses: [
      {
        ...
        qualification: 'IGCSE',
        sections: [
          { id: 'C4.4', page: 23, primary: true },
          { id: 'E4.4', page: 47 },
        ],
      },
    ],
    href: '/labs/mathematics/similarity-scale-effects.html',
  },
  {
    subject: 'computer-science',
