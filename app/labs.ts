...
export const labs: Lab[] = [
  ...
  },
  {
    ...
    description: 'Build rounded-value intervals, calculate the slowest possible speed, and decide whether a claim is guaranteed.',
    ...
    subtitle: 'Build the possible measurement intervals, then test the claim with the slowest possible speed.',
    topic: 'Numbers',
    format: 'Bounds proof',
    kind: 'lab',
    syllabuses: [
