  ...
  },
  {
    ...
    qualificationViews: {
      IGCSE: {
        ...
        topicBriefings: {
          Numbers: 'Explore factors, sets, recurring decimals, rounded bounds, ratios and rates through interactive Cambridge IGCSE Mathematics 0580 experiments.',
        } satisfies Partial<Record<Topic, string>>,
      },
    },
  },
...
export const labs: Lab[] = [
  ...
  },
  {
    ...
    description: 'Adjust two pump rates to preserve a mixture ratio, fill each bottle exactly, and compare how proportional scaling changes composition and throughput.',
    ...
    subtitle: 'For Cambridge IGCSE Mathematics 0580 Core and Extended, balance ingredient ratio and total flow as a bottling line changes speed and target volume.',
    topic: 'Numbers',
    format: 'Ratio and rate experiment',
    kind: 'lab',
    syllabuses: [
      {
        code: '0580',
  ...
  },
  {
    ...
    description: 'Align repeating decimal tails, subtract them exactly, and trace how repeated remainder states produce an equivalent fraction.',
    ...
    subtitle: 'For Cambridge IGCSE Mathematics 0580 Extended, align an infinite recurring tail, cancel it by subtraction, and connect the cycle to an exact fraction.',
    topic: 'Numbers',
    format: 'Recurring decimal experiment',
    kind: 'lab',
    syllabuses: [
  ...
  },
  {
    ...
    description: 'Scrub possible true values inside rounding intervals, calculate extreme speeds, and test whether a measurement claim is guaranteed.',
    ...
    subtitle: 'For Cambridge IGCSE Mathematics 0580 Core and Extended, reveal the intervals hidden by rounded measurements and build a worst-case speed proof.',
    topic: 'Numbers',
    format: 'Bounds experiment',
    kind: 'lab',
    syllabuses: [
      {
        code: '0580',
  ...
  },
  {
    ...
    description: 'Place elements in a live Venn diagram, build union, intersection and complement rules, and inspect exactly who enters the resulting set.',
    ...
    subtitle: 'For Cambridge IGCSE Mathematics 0580 Core and Extended, place elements by membership, build set rules, and test each resulting Venn region.',
    topic: 'Numbers',
    format: 'Set operations experiment',
    kind: 'lab',
    syllabuses: [
      {
        code: '0580',
